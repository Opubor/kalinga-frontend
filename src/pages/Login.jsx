...
function Login() {
  ...
  return (
    <div className="rounded-sm border border-stroke text-black dark:text-white shadow-default h-screen dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            ...
            <p className="2xl:px-20">
              Kalinga's world for caregiving and Medical services
            </p>
